...
import { Award, Flame, Zap, Info, Goal, ArrowDownToLine, ArrowUpToLine, Trophy, Target, Map } from 'lucide-react';
    ...
    <main className="min-h-screen bg-slate-950 text-white p-6 pb-40 font-sans">
      <header className="text-center mb-10 pt-4 flex flex-col items-center">
        ...
        <div className="mt-4 inline-flex items-center gap-2 bg-slate-900 border border-slate-800 px-4 py-2 rounded-2xl mb-4">
          ...
          <p className="text-slate-400 text-[10px] font-black uppercase tracking-widest">8 Domande = 80 Punti</p>
        </div>
      ...
      <form onSubmit={saveBonus} className="max-w-md mx-auto space-y-6">
        ...
        {!isExpired && (
          <div className="fixed bottom-24 left-0 right-0 p-6 flex justify-center z-50 pointer-events-none">
            <button disabled={loading} type="submit" className="pointer-events-auto max-w-xs w-full bg-yellow-500 text-slate-950 font-black py-5 rounded-2xl uppercase text-[11px] tracking-widest shadow-2xl transition-all flex items-center justify-center gap-3 italic active:scale-95">
